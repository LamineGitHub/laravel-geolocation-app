...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-2 rounded-sm border-b-4 border-indigo-400 text-sm font-medium leading-5
            text-gray-900 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
            : 'inline-flex items-center px-1 pt-2 rounded-sm border-b-4 border-transparent text-sm font-medium leading-5
