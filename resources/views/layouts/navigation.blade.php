<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-14">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{--                        {{ __('Dashboard') }}--}}
                    {{--                    </x-nav-link>--}}
                    <x-nav-link :href="route('region.index')" :active="request()->routeIs('region.*')">
                        {{ __('Region') }}
                    </x-nav-link>
                    <x-nav-link :href="route('promoteur.index')" :active="request()->routeIs('promoteur.*')">
                        {{ __('Promoteur') }}
                    </x-nav-link>
                    <x-nav-link :href="route('zone.index')" :active="request()->routeIs('zone.*')">
                        {{ __('Zone') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('promoteur.index')" :active="request()->routeIs('promoteur.*')">
                {{ __('Promoteur') }}
            </x-responsive-nav-link>
